...
//	}
	...
	public String getGenerarReporte(String archivoBase, String archivoSalida, List<ChkHistorialAccesos> listaReporte){
		String respuesta = "OK";
		try {
            ...
            cell.setCellValue(getData(getUsuario()+"    Fecha Generacion:   "+getFecha()));
	        ...
	        while (it.hasNext()){
	        	ChkHistorialAccesos dto = (ChkHistorialAccesos) it.next();
        		row	 = sheet.createRow(fila);
	        	cellA = row.createCell(0);
        		cellA.setCellValue(getData(new SimpleDateFormat("dd/MM/yyyy").format(dto.getFecha())));
        		cellA.setCellStyle(style2);
        		cell8 = row.createCell(1);
        		cell8.setCellStyle(style2);
        		cell8.setCellValue(getData(dto.getIp()));
        		cellB = row.createCell(2);
        		cellB.setCellValue(getData(dto.getUsuario()));
        		cellB.setCellStyle(style2);
        		cellC = row.createCell(3);
        		cellC.setCellValue(getData(dto.getResultado()));
